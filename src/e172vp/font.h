...
public:
    ...
    static void createTextureImage32(const vk::Device &logicalDevice, const vk::PhysicalDevice &physicalDevice, const vk::CommandPool &commandPool, const vk::Queue &copyQueue, void *pixels, size_t w, size_t h, vk::Image *image, vk::DeviceMemory *imageMemory);
